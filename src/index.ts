...
await client.application.createGlobalCommand({ name: "remindme", integrationTypes: [0, 1], contexts: [0, 1, 2], description: "Set a reminder", type: 1, options: [{ name: "duration", description: "Duration of the reminder", required: true, type: 3 }, { name: "content", description: "Content of the reminder", required: true, type: 3 }, { name: "ephemeral", description: "Don't show others the reminder message", required: false, type: 5 }] });
